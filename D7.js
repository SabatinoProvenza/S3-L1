...
const filmPiuVecchio = () => {
  let piuVecchio = movies[0]

  movies.forEach((film) => {
    if (film.Year < piuVecchio.Year) {
      piuVecchio = film
    }
  })
  return piuVecchio
...
const estraiTitoli = (films) => films.map((film) => film.Title)

/* ESERCIZIO 12 (filter)
  Scrivi una funzione per ottenere dall'array fornito solamente i film usciti nel millennio corrente.
*/

const filmMillennio = (films) => films.filter((film) => film.Year >= 2000)
